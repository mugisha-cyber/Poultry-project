...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    if (!empty($date) && !empty($details) && !empty($amount)) {
        $sql = "INSERT INTO rukundo (date, details, amount) VALUES ('$date', '$details', '$amount')";
        if ($conn->query($sql)) {
...
<div class="container">
    <h2>🐔 Rukundo Project - Add Transaction</h2>
    ...
    <div class="links">
        <a href="view_rukundo.php">📊 View All TRANSACTION</a> |
