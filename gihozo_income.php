...
if (isset($_POST['save'])) {
    ...
    if (!empty($date) && !empty($details) && !empty($amount)) {
        $sql = "INSERT INTO `gihozo_income` (DATE, DETAILS, AMOUNT) VALUES ('$date', '$details', '$amount')";
        if ($conn->query($sql)) {
...
<a href="view-gihozo-income.php">📊 View All Income</a> | 
