...
if (isset($_POST['save'])) {
    ...
    if (!empty($date) && !empty($details) && !empty($amount)) {
        $sql = "INSERT INTO `income_of_75` (DATE, DETAILS, AMOUNT) VALUES ('$date', '$details', '$amount')";
        if ($conn->query($sql)) {
...
<head>
    ...
    <title>Add Inkoko 75 Income</title>
    <style>
...
<a href="view-income_of_inkoko75.php">📊 View All Income</a> | 
